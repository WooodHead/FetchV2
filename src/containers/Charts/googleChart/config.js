...
const BarChart = {
  ...
  data: [
    ...
    ['2010', 132, 'fill-color: #48A6F2; fill-opacity: 0.4'],
    ['2012', 208, 'fill-color: #f64744; fill-opacity: 0.4'],
    ['2014', 98, 'fill-color: #ffbf00; fill-opacity: 0.4'],
    ['2016', 56, 'fill-color: #511E78; fill-opacity: 0.4'],
  ],
  options: {
    title: 'New Customers from 2010 to 2016',
    titleTextStyle: {
      color: '#788195',
    },
    bar: {
